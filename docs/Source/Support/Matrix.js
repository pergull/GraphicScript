...
(function (GraphicScript) {
    var Matrix = (function () {
        ...
        Matrix.prototype.load = function (matrix) {
            var m = this.m;
            m[0] = matrix[0];
            m[1] = matrix[1];
            m[2] = matrix[2];
        ...
        Matrix.prototype.lookAt = function (eyeX, eyeY, eyeZ, centerX, centerY, centerZ, upX, upY, upZ) {
            ...
            GraphicScript.Vector.normalizeStatic(forward);
            var up = [];
            up[0] = upX;
            up[1] = upY;
            up[2] = upZ;
            GraphicScript.Vector.normalizeStatic(up);
            // side = forward x up
            var side = [];
            GraphicScript.Vector.crossStatic(forward, up, side);
            GraphicScript.Vector.normalizeStatic(side);
            // Recompute up as: up = side x forward
            GraphicScript.Vector.crossStatic(side, forward, up);
            // define t as
            t[0] = side[0];
            t[1] = up[0];
            t[2] = -forward[0];
        ...
        Matrix.prototype.ortho = function (left, right, bottom, top, zNear, zFar) {
            var t = this.t;
            t[0] = 2.0 / (right - left);
            t[1] = 0.0;
            t[2] = 0.0;
        ...
        Matrix.prototype.frustum = function (left, right, bottom, top, zNear, zFar) {
            var t = this.t;
        ...
        Matrix.prototype.multiplyWith = function (m2) {
            var t = this.t;
            for (var i = 0; i < 16; i++) {
                t[i] = m2.m[i];
            }
        ...
        Matrix.prototype.inverse = function (m2) {
            var m = this.m;
            for (var i = 0; i < 16; i++) {
                m[i] = m2.m[i];
            }
        ...
        Matrix.prototype.invertMatrix = function () {
            var m = this.m;
            var m00 = m[0];
            var m01 = m[1];
            var m02 = m[2];
